...
static board_id_map_t PCBA_DETECT_POCO_INDIA[] = {
...
static bool read_pcba_config_j19(void)
{
	...
	} else if (pcba_config == PCBA_J19P_POCO_INDIA) {
		board_id_map = PCBA_DETECT_POCO_INDIA;
		map_size = sizeof(PCBA_DETECT_POCO_INDIA)/sizeof(board_id_map_t);
	}
